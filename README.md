# 🔗 Telemetry-Driven URL Management for Developers
...
|          **Dynamic Landing Experience**           |              **High-Density Dashboard**              |
| :-----------------------------------------------: | :--------------------------------------------------: |
|  ![Homepage](./screenshots//tinyroute-home.png)   | ![Dashboard](./screenshots//tinyroute-dashboard.png) |
| _Hero section with integrated redirection engine_ | _Bento-box layout with relative traffic indicators_  |

|             **High-Fidelity Telemetry**              |              **Scanning Viewfinder QR**               |
| :--------------------------------------------------: | :---------------------------------------------------: |
| ![Analytics](./screenshots//tinyroute-analytics.png) |    ![QR Popup](./screenshots/tinyroute-qrcode.png)    |
|  _Custom-themed charts with area-gradient overlays_  | _Glassmorphism modal with animated diagnostic loader_ |
